...
namespace CliCountry.Facturacion.Web.WebExterno.Facturacion
{
    ...
    public partial class AdministradorFacActividad : WebPage
    {
        ...
        private void ActivarCeldaGridView(GridView grillaVinculaciones, int indiceFila)
        {
            ...
            {
                RecorrerFilas(fila, indiceFila);
            }
        }

        private void RecorrerFilas(GridViewRow fila, int indiceFila)
         {
        ...
        private bool CargarDatosCliente()
        {
            ...
            if (Atencion != null)
            {
                ...
                {
                    cargarInformacion = cargarDatosAtencion(Atencion);
                }
                else
                {
                    cargarInformacion = limpiarDatosAtencion();
                }
            }
            else
            {
        ...
        public bool cargarDatosAtencion(AtencionCliente Atencion)
        {
        ...
        public bool limpiarDatosAtencion()
        {
            LimpiarDatosBasicos();
        ...
        private void CargarVentas(int identificadorAtencion, List<int> ventasMarcadas)
        {
            ...
            Resultado<Paginacion<List<Venta>>> respuesta = WebService.Facturacion.ConsultarVentasAtencion(parametrosConsulta);
            
            if (respuesta.Ejecuto)
            {
                validarVentas(respuesta, ventasMarcadas, identificadorAtencion);
            }
            else
            {
        ...
        public void validarVentas(Resultado<Paginacion<List<Venta>>> respuesta, List<int> ventasMarcadas, int identificadorAtencion)
        {
        ...
        private void CargarVinculaciones(Vinculacion atencion)
        {
            ...
            if (resultado.Ejecuto)
            {
                ...
                {
                    grvEntidades.EmptyDataText = "No se encontro información relacionada";
                }
            }
            else
            {
